...
<article id="article3">
<form method="POST" name="IdForm" id="form2" action="findIdStep2">
	...
	<fieldset id="fieldset3"><div><h2 align="center">아이디/비밀번호 찾기</h2></div>
		<table class="table3">
			<tr id="email2">
				<th align="center" colspan="2"><h3>회원님의 이메일 주소(${dto.email})로 인증정보가 발송되었습니다.
				메일을 확인하시기 바랍니다.</h3>	
			</tr>
			<tr id="phone2">
				<th align="center" colspan="2"><h3>회원님의 휴대폰(${dto.phone})으로 인증정보가 발송되었습니다.
				메세지를 확인하시기 바랍니다.</h3>
			</tr>
