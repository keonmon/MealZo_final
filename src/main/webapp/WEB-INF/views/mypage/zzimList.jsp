...
<tr><td width="100px">${zzimVO.ZSEQ}</td>
...
<td width="140px" style="font-wight:bold;"><a href="productDetail?pseq=${zzimVO.PSEQ}" style="color:black; font-weight:bold; font-size:25px;">${zzimVO.NAME}</a>
