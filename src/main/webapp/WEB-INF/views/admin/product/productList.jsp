...
<form name="frm" method="post" >
	<table>
		<tr><td width="460">상품명<input type="text" name="key" value="${key }">
...
<table id="tableContainer" style="text-align:center;" width="85%">
	...
	<tr>
		...
		<td>
			...
			<td><input type="checkbox" name="checkBox_pseq" value="${mproductVO.PSEQ }"></td>
			</tr>
	</c:forEach>
</table>
</form>
