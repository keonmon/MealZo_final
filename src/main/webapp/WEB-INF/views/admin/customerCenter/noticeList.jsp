...
<table id="tableContainer" style="text-align:center;" width="85%">
	...
	<c:forEach items="${noticeList }" var="noticeVO">
		<tr>
			...
			<td style="">
				<a href="meal.do?command=adminNoticeDetail&nseq=${noticeVO.nseq }" style="text-decoration:none;">
					${noticeVO.subject }
				</a>
			</td>
...
<jsp:include page="../paging/paging.jsp">
	<jsp:param name="command" value="meal.do?command=adminNoticeList" />	
</jsp:include>
...
<br><br>
	...
	<input type="button" class="btn" style="width:200px;" value="체크항목 변경" onclick="go_notice_save()">
<br><br>
</article>
