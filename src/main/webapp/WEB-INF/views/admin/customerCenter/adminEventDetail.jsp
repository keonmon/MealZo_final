...
<fmt:formatDate value="${eventVO.startdate}" pattern="yyyy-MM-dd" var="startDate" />
<fmt:formatDate value="${eventVO.enddate}" pattern="yyyy-MM-dd" var="endDate" />
<fmt:formatDate value="${eventVO.startdate}" pattern="HH:mm:ss" var="startTime" />
<fmt:formatDate value="${eventVO.enddate}" pattern="HH:mm:ss" var="endTime" />

<article id="mypageArticle2" style="width:900px; max-width:900px;">
	<h2>이벤트 관리</h2>
	<form name="frm" method="post" enctype="multipart/form-data" >
		<input type="hidden" name="eseq" value="${eventVO.eseq}">
		<input type="hidden" name="oldImage1" value="${eventVO.image1 }">
		<input type="hidden" name="oldImage2" value="${eventVO.image2 }">
	...
	<table id="tableContainer" width="100%">
		<tr><th width="75px">이벤트명</th>
            ...
            <th width="45px" >No.</th>
			<td width="85px" style="text-align:center;">${eventVO.eseq }</td>
		</tr>
		<tr>
			<th width="75">기간</th>
			...
			<td width="85px" style="text-align:center;" >
				<fmt:formatDate value="${eventVO.writedate }" type="date"/>
			</td>
		</tr>
		<tr>
			<th>소제목</th>
			<td style="text-align:left; padding:5px 10px;" width="400px" colspan="2">
            <input width="400px" type="text" name="subtitle" size="47" maxlength="100" value="${eventVO.subtitle }"></td>
		</tr>
		<tr><th>내용</th>
				<td colspan="4">
					<textarea name="content" rows="8" cols="70" style="width:650px; max-width:650px; min-width:650px; height:250px">${eventVO.content }</textarea></td></tr>
		<tr><th>썸네일<br>이미지</th>
				<td colspan="4">
					<img src="images/${eventVO.image1 }" width="300px" style="max-height:300px;"> (최적크기 : 285px * 285px)<br>
					<input type="file" name="image1"></td></tr>
		<tr><th>내용<br>이미지</th>
				<td colspan="4">
					<img src="images/${eventVO.image2 }" width="300px" style="max-height:300px;"> (이미지는 게시물 최상단에 위치합니다)<br>
