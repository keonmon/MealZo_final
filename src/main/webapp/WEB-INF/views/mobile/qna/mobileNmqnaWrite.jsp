...
<form style="margin-top:5%; text-align:center; margin-left:40px; width:90%; height:70%" action="mobileNmqnaWrite">
	<table id="qnaWrite">
        <tr style="hieght:100px; width:90%;">
       	    <td style="font-size:1.5em; width:30% "><h2>임시아이디</h2> </td>
            <td style="font-size:1.5em; text-align:center;">
        		<input style="background:silver; width:100%; text-align:center; height:60px; font-size:1.5em;" type="text" name="id">
            </td>
        </tr>
         <tr height="100px;">
       	    <td style="font-size:1.5em; "><h2>임시비밀번호</h2> </td>
            <td style="font-size:1.5em; text-align:center;">
        		<input placeholder="비회원문의 확인시 필요" style="background:silver; text-align:center; width:100%; height:60px; font-size:1.5em;" type="text" name="pwd">
            </td>
        </tr>
         <tr height="100px;">
       	    <td style="font-size:1.5em; "><h2>제목</h2> </td>
            <td style="font-size:1.5em; text-align:center;">
        		<input style="background:silver; text-align:center; width:100%; height:60px; font-size:1.5em;" type="text" name="subject">
            </td>
        </tr>
		 <tr height="100px;">
	...
	<table style="width:100%">
		 <tr height="100px;">
            <td style="font-size:1.5em; text-align:center;">
        		<input style="background:silver; width:100%; height:400px; font-size:1.5em;" type="text" name="content" >
            </td>
        </tr>
	</table>
