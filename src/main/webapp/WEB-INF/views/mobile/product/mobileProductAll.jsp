...
<ul>
<li><a href="mobileProductAllForm?sort=recently&sub=y&idx=0&key=${key }">최근등록순</a></li>
	<li><a href="mobileProductAllForm?sort=low_price&sub=y&idx=1&key=${key }">가격낮은순</a></li>
	<li><a href="mobileProductAllForm?sort=high_price&sub=y&idx=2&key=${key }">가격높은순</a></li>
</ul>
</div>
