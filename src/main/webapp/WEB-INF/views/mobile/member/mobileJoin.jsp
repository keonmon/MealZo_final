...
<article id="article2">
<form method="post" name="joinForm" id="form2" style="margin-top:8%;">
	<fieldset id="fieldset2"><h2 align="center">회원정보 입력</h2>
	
	
	<table id="table2">
	<tr><th id="th2"><label>아이디</label></th><th id="th7"><input type="text" name="id" size="6" placeholder="공백 없는 영문/숫자 포함 6~20자"  class="text3" style="border:0 solid black;"><input type="hidden" name="reid">
	    <input type="button" value="중복 체크" class="dup" onclick="idcheck()"></th></tr>
	    <tr><th id="th2"><label>비밀번호</label></th><th id="th7"><input type="password" name="pwd" size="6" placeholder="공백 없는 영문/숫자 포함 6~20자"  class="text3" style="border:0 solid black;"></th></tr> 
