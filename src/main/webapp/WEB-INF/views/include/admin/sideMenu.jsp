...
<ul>
   ...
   <li id="menu"><a href='adminMemberList?sub=y'>회원 관리</a></li><br>
   
   <li id="menu"><p id="mypage2"><a href="adminQnaList?sub=y">고객서비스 관리</a>
     <ul>
   ...
   <li id="menu"><p id="mypage2"><a href='adminNoticeList?sub=y'>공지&이벤트</a>
		<ul>
			<li><a href='adminNoticeList?sub=y'>공지사항</a></li>
			<li><a href='adminEventList?sub=y'>이벤트</a></li><br>
		</ul>
   </li>
   <li id="menu"><p id="mypage2"><a href='adminBannerList?sub=y'>메인배너관리</a></li>
</ul>
</nav>