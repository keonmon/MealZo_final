...
<h2>비회원 Q&amp;A</h2>
 <h3>비회원고객님의 질문에 대하여 운영자가 1:1 답변을 드립니다.</h3>
 <form name="formm" method="post">
 <table id="cartList"  width="100%" style="text-align:center;">
 	<tr><th width="50px">번호</th><th>제목</th><th>임시아이디</th><th>등록일</th><th>답변 여부</th></tr>
 	<c:forEach items="${nmqnaList}" var="mqnaVO">
	 	<tr><td>${mqnaVO.NQSEQ}</td>
	 		<td style="width:500px; word-break:break-all"><a href="pwdcheck?nqseq=${mqnaVO.NQSEQ}">${mqnaVO.SUBJECT}</a></td>
	 		<td>${mqnaVO.ID}</td>
...
<jsp:include page="../include/paging/paging.jsp">
 ...
 <div id="buttons" style="float:right">
 	...
 	<input type="button" value="질문하기" class="submit" onClick="location.href='nmqnaWriteForm'">
