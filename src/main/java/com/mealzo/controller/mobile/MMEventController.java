...
@Controller
public class MMEventController {
	...
	@RequestMapping("mobileEventList")
	  public ModelAndView eventList(HttpServletRequest request,
	      ...
	      HttpSession session = request.getSession();
	          ...
	          mav.setViewName("mobile/customerCenter/mobileEventList");
	      return mav;
	  }
	...
	@RequestMapping("mobileEventDetail")
	  public ModelAndView eventDetail(HttpServletRequest request,
	      ...
	      mav.setViewName("mobile/customerCenter/mobileEventDetail");
